...
class DailyAnalPage extends StatefulWidget {

  @override
  _DailyAnalPageState createState() => new _DailyAnalPageState();
}

class _DailyAnalPageState extends State<DailyAnalPage> {
  var finaldate;
  ...
  void callDatePicker() async {
    ...
    setState(() {
      ...
      format=updated_year+'-'+updated_month+'-'+updated_day;
    ...
    {
      if(_menugets[i].month==updated_month&&_menugets[i].year==updated_year&&_menugets[i].day==updated_day)
      {
        total_count++;
        ...
        child: new Column(
          ...
          children: <Widget>[
            ...
            new RaisedButton(
              ...
              color: Colors.yellow,
              child:
              new Text('Select Day', style: TextStyle(color: Colors.redAccent)),
            ),
            Padding(
